class CustomerDataMapper {
  ...
  static String branchImage(Map<String, dynamic> data, {required String seed}) {
    final fromData = stringValue(data, const [
      'imageUrl',
      'coverImageUrl',
      'heroImageUrl',
      'photoUrl',
    ...
    return _fallbackBranchImages[seed.hashCode.abs() %
        _fallbackBranchImages.length];
  }
