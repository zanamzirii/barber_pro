...
class _BookAppointmentScreenState extends State<BookAppointmentScreen> {
        ...
        return ListView(
          ...
          children: [
            ...
            _PolicyItem(
              ...
              text: 'Secure payment will be handled at the branch after your service.',
            ),
          ],
        );
      },
  ...
  Future<_ConfirmViewData> _loadConfirmViewData(String shopId) async {
    ...
    final currency = ((service['currency'] as String?)?.trim().isNotEmpty ?? false)
  ...
  DateTime _buildStartAt() {
    ...
    final targetWeekday = _weekdayFromLabel(_dateOptions[_selectedDateIndex].label);
    ...
    return Row(
      ...
      children: [
        Padding(
          ...
          child: Icon(icon, size: 18, color: AppColors.gold.withValues(alpha: 0.75)),
        ),
        const SizedBox(width: 10),
        Expanded(
          child: Text(
